...
if (Test-Path "$basedir/node$exe") {
  ...
  if ($MyInvocation.ExpectingInput) {
    $input | & "$basedir/node$exe"  "$basedir/../../../../../../rollup/1.15.5/node_modules/rollup/bin/rollup" $args
  } else {
    & "$basedir/node$exe"  "$basedir/../../../../../../rollup/1.15.5/node_modules/rollup/bin/rollup" $args
  }
  $ret=$LASTEXITCODE
} else {
  # Support pipeline input
  if ($MyInvocation.ExpectingInput) {
    $input | & "node$exe"  "$basedir/../../../../../../rollup/1.15.5/node_modules/rollup/bin/rollup" $args
  } else {
    & "node$exe"  "$basedir/../../../../../../rollup/1.15.5/node_modules/rollup/bin/rollup" $args
  }
  $ret=$LASTEXITCODE
}
